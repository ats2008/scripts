...
def printLinearTable(compiledData,printTagExp=False):
...
for line in Lines:
    ...
    for r in res:
        ...
        if pid in exception_prepids:    
            ...
            if x and ('madgraph-' in dsetname):    stats[pid]['madgraph']=True
...
printTableOfCompiledData(compiledData,FULL_DETAILS)    
print("\n\n\n")

print("Summary for standard configurations: HT-binned WJets MG5_aMC [MLM] \n")
printLinearTable(compiledHTBinStats)
print("\n\n\n")

printLinearTable(compiledPOGStats)
print("\n\n\n")

printLinearTable(compiledGeneratorStats,True)
print("\n\n\n")
